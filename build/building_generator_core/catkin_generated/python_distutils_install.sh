...
echo_and_run cd "/ws/SimEnv/src/building_generator_core"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/ws/SimEnv/src/building_generator_core/setup.py" \
     \
    build --build-base "/ws/SimEnv/build/building_generator_core" \
    install \
    --root="${DESTDIR-/}" \
